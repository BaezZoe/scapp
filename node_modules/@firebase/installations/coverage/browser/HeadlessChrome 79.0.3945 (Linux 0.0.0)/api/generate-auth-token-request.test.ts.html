...
<html lang="en">
<head>
    <title>Code coverage report for api/generate-auth-token-request.test.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">api</a> generate-auth-token-request.test.ts
    </h1>
    <div class='clearfix'>
